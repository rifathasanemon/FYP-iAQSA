...
if (isset($_POST['submit'])) {
    ...
    if ($pdf_file['error'] === UPLOAD_ERR_OK) {
        ...
        // Prepare the SQL statement to insert the file into the template2 table
        $stmt = $con2->prepare("INSERT INTO template2 (user_id, Fname, Lname, user_name, filename, filetype, filedata) VALUES (?, ?, ?, ?, ?, ?, ?)");
...
<h3>Upload File</h3>
                ...
                <label for="file">
                    <span>Click "<a href="Template2.pdf" download="Template2.pdf" style="direction:none; color:lightblue;"><strong>Template2.pdf</strong></a>" to download the template.</span>
                </label>
                <br>
                <label for="file">
                    <span>
