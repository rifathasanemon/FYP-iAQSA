...
<li><input type="button" class="active btn " value="Step 7" style="  background-color: whitesmoke; width:100px;border-radius: 15px 0 15px 0; "></li>
            ...
            <tbody>
                <?php foreach ($files as $file) : ?>
                    ...
                    <td><?php echo $file['Fname'], '&nbsp', $file['Lname']; ?></td>
                        ...
                        <td>
                        <a href="download7.php?file_id=<?php echo $file['user_id']; ?>">Download</a>
                        </td>
                        <td>
                                <a href="mailto:<?php echo $user_data['user_name']; ?>?subject=Feedback%20for%20Step%207">
