...
<li><input type="button" class="active btn " value="Step 2" style="  background-color: whitesmoke; width:100px;border-radius: 15px 0 15px 0; "></li>
            ...
            <tbody>
                <?php foreach ($files as $file) : ?>
                    ...
                    <td><?php echo $file['Fname'], '&nbsp', $file['Lname']; ?></td>
                        ...
                        <td>
                        <a href="download2.php?file_id=<?php echo $file['user_id'];?>"style="color:blue;">Download</a>
                        </td>
                        <td>
                                <a href="mailto:<?php echo $user_data['user_name']; ?>?subject=Feedback%20for%20Step%202">
