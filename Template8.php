...
if (isset($_POST['submit'])) {
    ...
    if ($pdf_file['error'] === UPLOAD_ERR_OK) {
        ...
        // Prepare the SQL statement to insert the file into the template8 table
        $stmt = $con2->prepare("INSERT INTO template8 (user_id, Fname, Lname, user_name, filename, filetype, filedata) VALUES (?, ?, ?, ?, ?, ?, ?)");
...
<h3>Upload File</h3>
                ...
                <label for="file">
                    <span>Click "<a href="Template8.pdf" download="Template8.pdf" style="direction:none; color:lightblue;"><strong>Template8.pdf</strong></a>" to download the template.</span>
                </label>
                <br>
                <label for="file">
                    <span>
