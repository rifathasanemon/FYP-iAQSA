...
<li><input type="button" class="active btn " value="Step 5" style="  background-color: whitesmoke; width:100px;border-radius: 15px 0 15px 0; "></li>
      ...
      <table style="  margin-bottom:7%">
            <thead>
                ...
                <th>Research Question</th>
                    ...
                    <th>Theme</th>
                    <th>Main Idea 1</th>
                    <th>Main Idea 1 Verb Support</th>
                    <th>Main Idea 2</th>
                    <th>Main Idea 2 Verb Support</th>
                    <th>Main Idea 3</th>
                    <th>Main Idea 3 Verb Support</th>
                    <th>Interrater</th>
                    <th>Comments</th>
                    <th>Feedback</th>
            ...
            <tbody>
                <?php foreach ($data as $item) : ?>
                    ...
                    <td><?php echo $item['Fname'], '&nbsp', $item['Lname']; ?></td>
                        <td><?php echo $item['RQ']; ?></td>
                        <td><?php echo $item['IQ']; ?></td>
                        <td><?php echo $item['theme']; ?></td>
                        <td><?php echo $item['mainIdea1']; ?></td>
                        <td><?php echo $item['mainIdea1_verbSupportI1']; ?></td>
                        <td><?php echo $item['mainIdea2']; ?></td>
                        <td><?php echo $item['mainIdea2_verbSupportI2']; ?></td>
                        <td><?php echo $item['mainIdea3']; ?></td>
                        <td><?php echo $item['mainIdea3_verbSupportI3']; ?></td>
                        <td><?php echo $item['interrater']; ?></td>
                        <td><?php echo $item['comments']; ?></td>
                        <td>
                                <a href="mailto:<?php echo $item['user_name']; ?>?subject=Feedback%20for%20Step%205">
